...
(function ($) {
	...
	$(document).ready(function () {
		...
		$('html').click(function (e) {
			if (!$(e.target).is(".tesla-secure-area *")) {
				$(".toggle-box").hide();
...
jQuery(document).ready(function($){
	...
	//* wp-themes infinite scroll end */
	
	//* wp-themes lazzy load */
	...
	$('.dashboard-menu .tt-am-tabs #menu-content-category-2').click(function(){
		window.location.href = 'https://teslathemes.com/amember/content/c/id/3';
	});
	...
	$('.pricing-box a').on('mouseover',function(ev){
		if(typeof window.adoric !== 'undefined')
			adoric.trigger(this, 'pricing_hover');
	});
